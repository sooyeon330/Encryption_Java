			...
			public void run() {
				...
				enbtn.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						setBoard(key_text.getText());
						keytext = key_text.getText();
						...
						System.out.println(strEncryption(keytext,entext));
						encryption=strEncryption(keytext,entext);
						...
						decryption = strDecryption(keytext, encryption, zCheck);
